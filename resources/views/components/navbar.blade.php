<nav class="fixed top-0 left-0 w-full bg-[#E9B9C5] shadow-md z-[1000]">
  <div class="flex items-center justify-between px-4 sm:px-6 h-16">
    ...
    <div class="hidden md:flex text-white items-center space-x-20">
      ...
      <a href="#" class="px-4 py-2 font-medium rounded-md hover:bg-[#B9E9DD] hover:text-[#53AFA2] transition duration-300">Riwayat</a>
    </div>
  ...
  <div id="mobile-menu"
    ...
    <a href="#" class="block w-full text-center py-2 text-gray-800 hover:bg-[#B9E9DD] hover:text-[#53AFA2] transition">Riwayat</a>
  </div>
</nav>

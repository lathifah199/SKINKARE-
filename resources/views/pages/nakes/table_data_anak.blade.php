                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            data-umur="{{ $anak->umur }}" 
                            data-tb="{{ optional($anak->pemeriksaan->first())->tinggi_badan }}"
                            data-bb="{{ optional($anak->pemeriksaan->first())->berat_badan }}"
                            data-status="{{ optional($anak->hasilDeteksi->first())->kategori_risiko }}  ({{ optional($anak->hasilDeteksi->first())->risiko_persen }}%) {{ optional($anak->hasilDeteksi->first())->status_prediksi }}"
